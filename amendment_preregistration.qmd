...
The full item-by-item form—items 0.1 through I.3, with the tournament-specific extensions marked ★—is published in the [call for collaboration](index.html#registration-form). A fillable template (Markdown + machine-readable YAML) ships in the [tournament repository](https://github.com/janpfander/silicon-sample-submission).
